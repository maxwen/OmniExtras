...
public class CalendarAppWidgetService extends RemoteViewsService {
    ...
    public static class CalendarFactory extends BroadcastReceiver implements
        ...
        protected CalendarFactory(Context context, Intent intent) {
            ...
            mDeclinedColor = mResources.getColor(R.color.calendar_widget_item_declined_color);
            mStandardColor = mResources.getColor(R.color.calendar_widget_item_standard_color);
        }
        ...
        private long getSearchDuration() {
            return 14 /*Utils.getWidgetDays(mContext)*/ * DateUtils.DAY_IN_MILLIS;
        }
        ...
        public RemoteViews getLoadingView() {
            RemoteViews views = new RemoteViews(mContext.getPackageName(),
                    R.layout.calendar_widget_loading);
            return views;
        }
        ...
        public RemoteViews getViewAt(int position) {
            ...
            if (rowInfo.mType == CalendarAppWidgetModel.RowInfo.TYPE_DAY) {
                ...
                RemoteViews views = new RemoteViews(mContext.getPackageName(), R.layout.calendar_widget_item);
                ...
                final Intent fillInIntent = CalendarAppWidgetProvider.getLaunchFillInIntent(
                        eventInfo.id, start, end, eventInfo.allDay);
        ...
        private String queryForSelection() {
            return true /*Utils.getHideDeclinedEvents(mContext)*/ ? EVENT_SELECTION_HIDE_DECLINED
                    : EVENT_SELECTION;
        }
